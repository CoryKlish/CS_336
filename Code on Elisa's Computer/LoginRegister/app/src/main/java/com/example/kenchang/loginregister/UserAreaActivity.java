...
public class UserAreaActivity extends AppCompatActivity {
    ...
    public android.support.v4.app.Fragment previousFragment = null;
    ...
    public void selectItemDrawer(MenuItem menuItem){
        ...
        //if(counter==1) {
            fragmentManager.beginTransaction().replace(R.id.drawerLayout, myFragment).commit();
        //}//we need something to store the previous fragment so that we can replace it


        //else{
          //  fragmentManager.beginTransaction().replace(previousFragment, myFragment).commit();
        //}

        //fragmentManager.beginTransaction().replace(R.id.drawerLayout, myFragment).commit();
        //if(count==1) {
            //first add to it, next replace it
